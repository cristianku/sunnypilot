...
from openpilot.selfdrive.ui.sunnypilot.onroad.speed_vision import VisionSpeedLimitRenderer
...
class HudRendererSP(HudRenderer):
  def __init__(self):
    ...
    self.speed_vision_renderer = VisionSpeedLimitRenderer()
  ...
  def _update_state(self) -> None:
    ...
    self.speed_vision_renderer.update()
  ...
  def _render(self, rect: rl.Rectangle) -> None:
    ...
    self.speed_vision_renderer.render(rect)
